  ...
  <div>
    ...
    <div>
      <mt-swipe class="swipe" :auto="4000">
        <mt-swipe-item>
          <img src="../assets/CoUBGV2huWGABNXRABYiwUPhoZM790.jpg" alt />
        </mt-swipe-item>
        <mt-swipe-item>
          <img src="../assets/CoUBGV2hvguAODnpAB9rFlISjdc594.jpg" alt />
        </mt-swipe-item>
        <mt-swipe-item>
          <img src="../assets/CoUBGV2kYuqAS5FbAB8SBGtqpiw539.jpg" alt />
        </mt-swipe-item>
      </mt-swipe>
    </div>
    <!-- app 功能导航 找攻略、看游记 -->
